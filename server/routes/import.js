...
router.post('/legacy-excel', authenticate, authorize('admin', 'manager'), upload.array('files', 50), asyncHandler(async (req, res) => {
  ...
  await createAuditEntry(req.user.id, 'legacy_data_imported', 'system', null, req.ip, req.headers['user-agent'], {
